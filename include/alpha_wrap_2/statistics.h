...
namespace aw2 {
    struct TimingStats {
        ...
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(TimingStats, total_time, main_loop, gate_processing, rule_1_processing,
                                       rule_2_processing)
    };
    ...
    struct ConfigStats {
        ...
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(ConfigStats, input_file, alpha, offset, traversability_function,
